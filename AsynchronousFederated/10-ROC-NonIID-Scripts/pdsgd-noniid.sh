...
mpirun -np 10 python Train.py  --graph clique-ring --num_clusters 3 --name pdsgd-noniid-test1-10W --comm_style pd-sgd --momentum 0.9 --i1 1 --i2 1 --lr 0.8 --degree_noniid 0.5 --noniid 1 --resSize 18 --bs 32 --epoch 300 --description PDSGD --randomSeed 2828 --datasetRoot ./data --outputFolder Output
