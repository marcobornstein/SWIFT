...
mpirun -np 3 python train_mpi.py --description asyncDecentralized --resSize 50 --randomSeed 9001 --datasetRoot ./data --budget 1 --outputFolder Output --bs 64 --epoch 120 --name triangle
