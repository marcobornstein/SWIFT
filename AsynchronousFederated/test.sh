...
mpirun -np 16 python Train.py  --graph ring --num_clusters 3 --name dsgd-noniid-test1-10W --comm_style d-sgd --degree_noniid 1 --noniid 1 --resSize 18 --bs 32 --epoch 300 --description DSGD-paper --randomSeed 9001 --datasetRoot ./data --outputFolder Output
