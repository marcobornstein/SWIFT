...
mpirun -np 6 python Train.py  --graph fully-connected --num_clusters 3 --name padfed-test --sgd_steps 2 --personalize 1 --max_sgd 10 --resSize 50 --bs 64 --epoch 80  --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
