...
mpirun -np 10 python Train.py --weight_type adfl --name adfed-test --graph ring --num_clusters 3 --sgd_steps 2 --personalize 0 --max_sgd 5 --degree_noniid 1 --noniid 0 --resSize 50 --bs 64 --epoch 200 --description AdFed --randomSeed 9001 --datasetRoot ./data --outputFolder Output
