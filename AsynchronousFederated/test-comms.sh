...
mpirun -np 4 python Train.py  --graph fully-connected --name dsgd-test --comm_style dsgd --personalize 0 --resSize 50 --bs 64 --epoch 30 --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
