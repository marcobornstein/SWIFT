...
mpirun -np 4 python Train.py  --graph fully-connected --name pdsgd-test --comm_style pd-sgd --i1 2 --resSize 50 --bs 64 --epoch 25  --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
