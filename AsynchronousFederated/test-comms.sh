...
mpirun -np 9 python Train.py  --graph ring --num_clusters 3 --name padfed-test --sgd_steps 2 --personalize 1 --max_sgd 10 --resSize 50 --bs 64 --epoch 15  --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
