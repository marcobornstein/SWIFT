...
mpirun -np 8 python Train.py  --graph fully-connected --name dsgd-test --comm_style d-sgd --resSize 50 --bs 64 --epoch 25 --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
...
# mpirun -np 5 python Train.py  --graph ring --name padfed-test --sgd_steps 2 --num_clusters 1 --personalize 1 --max_sgd 10 --resSize 50 --bs 64 --epoch 100  --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
