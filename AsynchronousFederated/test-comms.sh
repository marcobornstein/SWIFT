...
mpirun -np 11 python Train.py --name padfed-test --graph clique-ring --num_clusters 3 --sgd_steps 2 --personalize 1 --max_sgd 5 --degree_noniid 1 --noniid 1 --resSize 50 --bs 64 --epoch 200 --description AdFed --randomSeed 9001 --datasetRoot ./data --outputFolder Output
