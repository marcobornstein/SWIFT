...
mpirun -np 4 python Train.py  --max_sgd 10 --resSize 50 --bs 64 --epoch 50 --name test-pers --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
