...
mpirun -np 4 python Train.py  --name less-iid-1sgd --graph fully-connected --sgd_steps 1 --num_clusters 1 --personalize 1 --max_sgd 10 --resSize 50 --bs 64 --epoch 325 --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
