...
mpirun -np 5 python Train.py --name weight-test-acc --graph fully-connected --sgd_steps 1 --personalize 1 --max_sgd 5 --degree_noniid 0.7 --noniid 0 --resSize 50 --bs 64 --epoch 5 --description asyncDecentralized --randomSeed 9001 --datasetRoot ./data --outputFolder Output
